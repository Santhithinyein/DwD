    ...
    <div
        ...
        <div
            ...
            <p class="truncate">
                ...
                <span class="text-red-800 hover:text-orange-400">စုပေါင်းဘုံကထိန်</span>
            </p>
            <p class="truncate">
                <i class="fa-solid fa-calendar-days text-red-800"></i>
                <span>Time :</span>
                <span class="text-red-800 hover:text-orange-400">၁၅.၁၁.၂၀၂၄ (နေ့လည် ၁ နာရီ)</span>
            </p>
            <p class="truncate">
                <i class="fa-solid fa-location-dot text-red-800"></i>
                <span>Place :</span>
                <span class="text-red-800 hover:text-orange-400">သီရိခေတ္တသိရိန္ဒရ သာသနာ့ဗိမာန်တော်ကြီး </span>
            </p>
        </div>
