...
<div class="mx-20">
    ...
    <div class="relative mb-5 text-right">
        ...
        <!-- <input type="text" class="w-60 h-10 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Search..."> -->
        ...
        <button type="submit" class="bg-red-800 w-16 h-10 rounded-lg hover:bg-orange-600 text-white" name="search">Refresh</button>
    </div>
</div>
    ...
    <div class="card flex flex-col lg:flex-row mx-10 rounded-lg md:mx-20 lg:mx-52 bg-white">
        ...
        <div class="card-details p-2">
            ...
            <div class="text-2xl text-red-800 mb-5 text-center font-semibold">
                <div class="name">Aung Thu Ka Monastery</div>
            </div>
            ...
            <div class="donateButton w-full h-10 bg-red-800 text-white text-xl rounded-full text-center p-1 justify-center hover:bg-orange-600">
                <button type="submit" class="justify-center"><a href="donateMulti.html" class="none">Donate Now</a></button>
            </div>
