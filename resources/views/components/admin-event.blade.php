<div class="flex-none w-80 bg-red-800">
    ...
    <div class="flex">
        ...
        <div class="border border-white w-44 h-24 ml-3 rounded">
    ...
    <div class="divide-y py-1 overflow-y-auto h-40">
        <div class="flex h-20 px-3 items-center">
            <img class="w-16 h-16 rounded-full" src="/images/k1.jpg" alt="">
            <p class="px-3 text-white">Hello</p>
        </div>
        <div class="flex h-20 px-3 items-center">
            <img class="w-16 h-16 rounded-full" src="/images/k1.jpg" alt="">
            <p class="px-3 text-white">Hello</p>
