{{-- <nav class="w-60 bg-yellow-500">
    <img src="/images/profile.jpg" alt="Profile Picture" class="h-20 w-20 rounded-full mx-auto  mt-3">
    <p class="text-center mt-2 text-white">Kay</p>
    <div class="flex mx-3 h-12 items-center border mt-8 rounded-md hover:bg-gray-100 hover:text-black text-white ">
     ...
     <span class="mx-3"><a href="{{route('dashboard')}}">Dashboard</a></span> 
    </div>

    <div class="flex mx-3  h-12 items-center border border-white mt-8 rounded-md hover:bg-gray-100 hover:text-black text-white ">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 ml-3">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z" />
      </svg>
      
     <span class="mx-3"><a href="{{route('monasteries.index')}}">Monasteries</a></span> 
    </div>
    <div class="flex mx-3 h-12 items-center border border-white mt-8 rounded-md hover:bg-gray-100 hover:text-black text-white ">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 ml-3">
     ...
     <span class="mx-3 "><a href="{{route('doners')}}">Donors</a></span> 
    </div>
    <div class="flex mx-3 h-12 items-center border border-white mt-8 rounded-md hover:bg-gray-100 hover:text-black text-white ">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 ml-3">
     ...
     <span class="mx-3"> <a href="{{route('users')}}">Users</a></span> 
    </div>
    <div class="flex mx-3 h-12 items-center border border-white mt-8 rounded-md hover:bg-gray-100 hover:text-black text-white ">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 ml-3">
  ...
  {{-- <nav class="w-60 bg-gradient-to-b from-amber-300 to-red-800 shadow-lg">
    <img src="/images/profile.jpg" alt="Profile Picture" class="h-24 w-24 rounded-full mx-auto mt-5 border-4 border-white shadow-md">
    <p class="text-center mt-4 text-xl font-semibold text-white">Kay</p>

    <div class="flex mx-4 h-12 items-center border mt-10 rounded-md hover:bg-gray-700 hover:text-white text-gray-300">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 ml-3">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m0 0a2.246 2.246 0 0 0-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0 1 21 12v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6c0-.98.626-1.813 1.5-2.122" />
        </svg>
        <span class="mx-3"><a href="{{route('dashboard')}}" class="font-medium">Dashboard</a></span>
    </div>

    <div class="flex mx-4 h-12 items-center border mt-6 rounded-md hover:bg-gray-700 hover:text-white text-gray-300">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 ml-3">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z" />
        </svg>
    ...
    <div class="flex mx-4 h-12 items-center border mt-6 rounded-md hover:bg-gray-700 hover:text-white text-gray-300">
        ...
        <span class="mx-3"><a href="" class="font-medium">Settings</a></span>
    </div>
  </nav> --}}

  <nav class="w-60 bg-gradient-to-b  from-[#f4bf07] to-[#8c240c] shadow-xl">
    ...
    <div class="flex mx-4 h-12 items-center mt-10 rounded-md hover:bg-[#faba3d]  text-gray-300 hover:text-black hover:border hover:border-[#fb9e05]">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 ml-3">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m0 0a2.246 2.246 0 0 0-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0 1 21 12v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6c0-.98.626-1.813 1.5-2.122" />
        </svg>
        <span class="mx-3"><a href="{{route('dashboard')}}" class="font-medium">Dashboard</a></span>
