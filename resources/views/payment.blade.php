            ...
            <div class="flex flex-wrap -m-4">
                <div class="p-4">
                    <div class="h-full border-2 border-white border-opacity-60 rounded-lg overflow-hidden">
                        <img src="/images/kt6.jpg" alt="image"
            ...
            <form id="paymentForm" action="{{ route('qrpay') }}" method="get">
                ...
                <div class="text-center mb-5 pt-5">
                    <h5 class="text-base md:text-lg text-gray-500 mb-1">
                        ...
                        &nbsp;&nbsp;
                        <span class="en">Your Donation</span>
                        <span class="mm"> အလှူရှင်၏လှူဒါန်းမှု</span>
                    </h5><br>
                    <p class="text-sm text-gray-900">
                        <span class="en">Choose a payment method</span>
                        <span class="mm"> ငွေပေးချေမှုနည်းလမ်းကို ရွေးချယ်ပါ။</span></p>
                </div>
                ...
                <div class="relative rounded-md flex justify-start items-center p-2">
                    ...
                    <span class="relative z-10">Wave Pay</span>
                </div>
